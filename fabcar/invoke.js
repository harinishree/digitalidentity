...
var options = {
    ...
    chaincode_id: 'digitalidentitychaincode8',
...
function addDocument(params) {
   ...
   return  Promise.resolve().then(() => {
        ...
        // console.log("line number  58---->", str);
        console.log("lkslkalkslk----->",updatedetails.rapidID,updatedetails.rapid_doc_ID)
        tx_id = client.newTransactionID();
        console.log("Assigning transaction_id: ", tx_id._transaction_id);
        // createCar - requires 5 args, ex: args: ['CAR11', 'Honda', 'Accord', 'Black', 'Tom'],
        // changeCarOwner - requires 2 args , ex: args: ['CAR10', 'Barry'],
...
function shareDocument(params) {
   ...
   return  Promise.resolve().then(() => {
        ...
        // console.log("line number  58---->", str);
        console.log("lkslkalkslk----->",shareddetails.rapidID,shareddetails.rapid_doc_ID,
        shareddetails.OrgID)
        tx_id = client.newTransactionID();
        console.log("Assigning transaction_id: ", tx_id._transaction_id);
        // createCar - requires 5 args, ex: args: ['CAR11', 'Honda', 'Accord', 'Black', 'Tom'],
...
function removedocs(params) {
   ...
   return  Promise.resolve().then(() => {
        ...
        console.log("revokeAccess", params.deleteDocs);
        // var str = JSON.stringify(revokeAccess.transactionstring)
        // console.log("line number  58---->", str);
        console.log("lkslkalkslk----->",deletedocs.rapidID)
        console.log("revokeAccess----->",deletedocs.rapid_doc_ID)
